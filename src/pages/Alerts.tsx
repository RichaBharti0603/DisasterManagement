  ...
  const alertsData: Alert[] = [
    {
      ...
      description: 'Severe cyclone approaching the eastern coast. Expected to make landfall in 24 hours.',
      location: 'Odisha',
      timestamp: '2023-09-15T08:30:00',
      severity: 'critical',
      instructions: 'Evacuate immediately if in coastal areas. Secure property and prepare emergency supplies.',
      isActive: true,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: 'Extreme temperatures recorded, posing health risks.',
      location: 'Rajasthan',
      timestamp: '2023-09-10T11:20:00',
      severity: 'high',
      instructions: 'Stay indoors, keep hydrated, and avoid direct sun exposure.',
      isActive: true,
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description: 'Heavy rains triggering landslides in hilly areas.',
      location: 'Himachal Pradesh',
      timestamp: '2023-09-01T16:30:00',
      severity: 'medium',
      instructions: 'Avoid traveling on hill roads. Stay alert for warnings from local authorities.',
      isActive: false,
    },
  ];
